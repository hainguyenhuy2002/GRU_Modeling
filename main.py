...
parser.add_argument('--k_eval', default=16, type=int) #value of K durig Recall and MRR Evaluation
...
parser.add_argument('--data_folder', default='/home/hainh/coccoc/code/week11/GRU4REC-pytorch/Dataset/RecSys_Dataset_After/', type=str)
